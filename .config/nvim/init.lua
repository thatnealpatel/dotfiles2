...
require('lazy').setup({
  ...
  { -- Add indentation guides even on blank lines
    ...
    main = "ibl",  -- required for version 3 (breaking changes from 2): https://github.com/lukas-reineke/indent-blankline.nvim/wiki/Migrate-to-version-3
...
-- Lazy set up (https://github.com/ray-x/go.nvim/blob/master/README.md)
...
vim.keymap.set('n', '<leader>sr', require('telescope.builtin').lsp_references, { desc = '[S]earch [R]eferences' }) -- exp
...
local servers = {
  ...
  -- LSP manager used: https://github.com/williamboman/mason-lspconfig.nvim
  --]]
  gopls = {
    settings = {
      gopls = {
